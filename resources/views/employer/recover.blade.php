    ...
    <div class="container">
        <div class="row align-items-start justify-content-center">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                ...
                <form class="border p-3 rounded" method="POST" action="{{ route('employer.recover.submit') }}">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-md full-width theme-bg text-light fs-md ft-medium">Send Link</button>
                    </div>
                </form>
